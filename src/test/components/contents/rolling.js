      ...
      >
        ...
        >
          ...
          <div className="flex gap-2 pt-2">
            <a
              href="https://github.com/Gyo50/Rolling"
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href="https://www.notion.so/Rolling-3136fb764ad180c78d66d1aa80daab2b?source=copy_link"
              target="_blank"
              rel="noreferrer"
        ...
        <div className="grid grid-cols-1 gap-3">
          ...
          >
            <DetailCard title="소개" icon="💌" isDark={isDark}>
              소중한 사람들에게 마음을 전할 수 있는 온라인 롤링페이퍼 웹
              서비스입니다. 사용자는 테마를 선택하여 롤링페이퍼 페이지를
              생성하고 지인들은 공유 링크를 통해 메시지를 남길 수 있습니다. 단순
              메시지 작성 기능을 넘어 일관된 UI 구조와 안정적인 데이터 처리 구조
              설계를 목표로 개발했습니다.
            </DetailCard>
            ...
            <DetailCard title="역할 및 기여 (팀장)" icon="👑" isDark={isDark}>
              <ul className="list-disc list-inside space-y-2 opacity-90 text-sm leading-relaxed">
                <li>
                  ...
                  확장성과 유지보수를 고려한 세부 폴더 구조를 설계하고, 프로젝트
                  전반의 기술 표준을 정립했습니다.
                </li>
                <li>
                  <span className="font-bold text-purple-500">
                  ...
                  팀원들의 코드를 상세히 리뷰하며 공통 코멘트를 통해 UI/UX의
                  일관성을 유지하고, 사용자 편의성을 극대화하기 위한 코드 품질
                  관리를 주도했습니다.
                </li>
                <li>
                  <span className="font-bold text-purple-500">
                  ...
                  팀장으로서 일정 관리뿐만 아니라 기능 추가 및 기술적 이슈에
                  대한 논의를 주도하며 팀 내 원활한 의사소통을 이끌었습니다.
                </li>
              </ul>
            </DetailCard>
            <DetailCard title="배운 점 & 성과" icon="📈" isDark={isDark}>
              <ul className="list-disc list-inside space-y-2 opacity-90 text-sm leading-relaxed">
                <li>
                  ...
                  처음에는 별도의 설치 없이 사용할 수 있는 fetch 방식을
                  사용했으나, JSON 처리와 공통 에러 핸들링, 인터셉트 로직을
                  추가하는 과정에서 한계를 느꼈습니다. 이후 Axios를 도입해 API
                  요청 구조를 정리하고, 보다 일관되고 확장 가능한 데이터 처리
                  방식을 경험했습니다.
                </li>
                ...
                <li>
                  ...
                  개인 프로젝트 위주로 개발해왔기 때문에 협업 방식에 익숙하지
                  않았지만, Git-flow 전략과 브랜치 관리 방식에 대해 학습하며
                  기능 단위로 작업을 분리하고 코드 충돌을 최소화하는 협업
                  프로세스를 경험했습니다.
                </li>
                ...
                <li>
                  ...
                  개발 과정에서 발생한 문제를 혼자 해결하기보다 팀원들과의 코드
                  리뷰와 논의를 통해 해결하면서, 기술적인 문제 해결뿐만 아니라
                  의사소통의 중요성을 체감했습니다.
                </li>
                ...
                <li>
                  ...
                  기획부터 개발, 배포(Vercel)까지 전 과정을 경험하며 단순 기능
                  구현을 넘어 서비스 단위로 프로젝트를 바라보는 시야를 넓힐 수
                  있었습니다.
                </li>
              </ul>
            </DetailCard>
